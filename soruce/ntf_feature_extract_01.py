...
def load(path):
	...
	df = df[df.__NOTIFICATION__death_period < 680400]
	return df
...
def main():
	...
	extract("../data/training/Train_extracted_notification_feature_2018-01-17_21-20-30.csv", '../data/feature/ntf_training_v3.csv')

	print("------------Extract Testing Data------------\n")
	extract("../data/testing/Test_extracted_notification_feature_2018-01-17_21-20-30.csv", '../data/feature/ntf_testing_v3.csv')
