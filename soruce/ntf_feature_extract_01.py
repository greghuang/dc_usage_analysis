...
def main():
	print('\n')
	print("------------Load Data------------\n")
	trainDF = load("../data/training/Train_extracted_notification_feature_2018-01-17_21-20-30.csv")
	testDF = load("../data/testing/Test_extracted_notification_feature_2018-01-17_21-20-30.csv")
