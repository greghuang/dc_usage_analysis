...
def main():
	print('\n')
	print("------------Load Data------------\n")
	trainDF = pd.read_csv("../data/training/Train_extracted_security_warning_feature_2018-01-17_21-20-30.csv")
	testDF = pd.read_csv("../data/testing/Test_extracted_security_warning_feature_2018-01-17_21-20-30.csv")
	...
	trainData.to_csv('../data/feature/sw_training_v3.csv')
	testData.to_csv('../data/feature/sw_testing_v3.csv')
